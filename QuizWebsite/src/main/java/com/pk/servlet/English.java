...
public class English extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) 
		...
		if(a1.equals("a")) {
			...
			pw.println("The correct anser for 1.Q is [a.  Adulation] <br>");
		
		if(a2.equals("d")) {
			count++;
		}else
			pw.println("The correct anser for 2.Q is [d.  Irrelevant] <br>");
		
		if(a3.equals("c")) {
			count++;
		}else
			pw.println("The correct anser for 3.Q is [c.  Beneficial] <br>");
		
		if(a4.equals("b")) {
			count++;
		}else
			pw.println("The correct anser for 4.Q is [b.  Entrepreneur] <br>");
		
		if(a5.equals("a")) {
			count++;
		}else
			pw.println("The correct anser for 5.Q is [a.  Excessive] <br>");
		
		if(a6.equals("d")) {
			count++;
		}else
			pw.println("The correct anser for 6.Q is [d.  She's waiting for you.] <br>");
		
		if(a7.equals("b")) {
			count++;
		}else
			pw.println("The correct anser for 7.Q is [b.  to] <br>");
		
		if(a8.equals("c")) {
			count++;
		}else
			pw.println("The correct anser for 8.Q is [c.  wait] <br>");
		
		if(a9.equals("b")) {
			count++;
		}else
			pw.println("The correct anser for 9.Q is [b.  Is] <br>");
		
		if(a10.equals("a")) {
			count++;
		}else
			pw.println("The correct anser for 10.Q is [a.  I'm giving him this antique watch.] <br>");
