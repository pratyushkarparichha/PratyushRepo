...
public class EmployeeMySQLDAOImpl implements IEmployeeDAO {
	private static final String EMP_INSERT_QUERY=
			                    "INSERT INTO REALTIMEDI_SPRING_EMPLOYEE(ENAME,DESG,BASICSALARY,GROSSSALARY,NETSALARY) VALUES(?,?,?,?,?)";
   //HAS-A Property
	private DataSource ds;
	
	public EmployeeMySQLDAOImpl(DataSource ds) {
		System.out.println("EmployeeMySQLDAOImpl:: 1-param with DataSource loading from cfgs");
	this.ds = ds;
	}
